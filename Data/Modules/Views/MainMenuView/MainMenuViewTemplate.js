...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function generateMainMenuView(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (menus, title) {;pug_debug_line = 1;pug_debug_filename = "D:\\Study\\TP\\FrontJohn\\2017_2_Sea_battle\\Data\\Modules\\Views\\BaseMenuView\\BaseMenuHeader.pug";
...
;pug_debug_line = 3;pug_debug_filename = "D:\\Study\\TP\\FrontJohn\\2017_2_Sea_battle\\Data\u002FModules\u002FViews\u002FMainMenuView\u002FMainMenuView.pug";
// iterate menus
;(function(){
  var $$obj = menus;
...
;pug_debug_line = 4;pug_debug_filename = "D:\\Study\\TP\\FrontJohn\\2017_2_Sea_battle\\Data\u002FModules\u002FViews\u002FMainMenuView\u002FMainMenuView.pug";
